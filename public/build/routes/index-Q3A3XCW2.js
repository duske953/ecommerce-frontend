import {
  ...
  require_react,
  useLoaderData
} from "/build/_shared/chunk-DVYBQWJN.js";
...
function canBeRendered(content) {
  return (0, import_react5.isValidElement)(content) || isStr(content) || isFn(content) || isNum(content);
}
var POSITION = {
  TOP_LEFT: "top-left",
  TOP_RIGHT: "top-right",
...
function cssTransition(_ref) {
  ...
  return function ToastTransition(_ref2) {
    ...
    const animationStep = (0, import_react5.useRef)(
      0
    );
...
function getIcon(_ref2) {
  ...
  if (icon === false)
    ...
    Icon = icon(iconProps);
  } else if ((0, import_react5.isValidElement)(icon)) {
    Icon = (0, import_react5.cloneElement)(icon, iconProps);
...
function useToastContainer(props) {
  ...
  const [toastIds, setToastIds] = (0, import_react5.useState)([]);
  const containerRef = (0, import_react5.useRef)(null);
  const toastToRender = (0, import_react5.useRef)(/* @__PURE__ */ new Map()).current;
  const isToastActive = (id) => toastIds.indexOf(id) !== -1;
  const instance = (0, import_react5.useRef)({
    toastKey: 1,
    displayedToast: 0,
    count: 0,
    queue: [],
  ...
  function buildToast(content, _ref2) {
    ...
    if ((0, import_react5.isValidElement)(content) && !isStr(content.type)) {
      toastContent = (0, import_react5.cloneElement)(content, {
        closeToast,
        toastProps,
        data
      });
...
function useToast(props) {
  ...
  const [preventExitTransition, setPreventExitTransition] = (0, import_react5.useState)(false);
  const toastRef = (0, import_react5.useRef)(null);
  const drag = (0, import_react5.useRef)({
    start: 0,
    x: 0,
    y: 0,
    delta: 0,
  ...
  const syncProps = (0, import_react5.useRef)(props);
  const {
    autoClose,
    pauseOnHover,
    closeToast,
  ...
  (0, import_react5.useEffect)(() => {
    ...
    if (isFn(props.onOpen))
      props.onOpen((0, import_react5.isValidElement)(props.children) && props.children.props);
    return () => {
      const props2 = syncProps.current;
      if (isFn(props2.onClose))
        props2.onClose((0, import_react5.isValidElement)(props2.children) && props2.children.props);
    };
  }, []);
  (0, import_react5.useEffect)(() => {
...
var Toast = (props) => {
  ...
  } else if (import_react5.default.isValidElement(closeButton)) {
    Close = import_react5.default.cloneElement(closeButton, closeButtonProps);
  } else {
    Close = CloseButton(closeButtonProps);
  }
  return import_react5.default.createElement(Transition, {
    isIn,
    done: deleteToast,
    position,
    preventExitTransition,
    ...
    style: bodyStyle
  }, iconOut != null && import_react5.default.createElement("div", {
    className: clsx_m_default("Toastify__toast-icon", {
      ["Toastify--animate-icon Toastify__zoom-enter"]: !isLoading
    })
  }, iconOut), import_react5.default.createElement("div", null, children)), Close, (autoClose || isProgressControlled) && import_react5.default.createElement(ProgressBar, {
...
var ToastContainer = (0, import_react5.forwardRef)((props, ref) => {
  const {
    getToastToRender,
    containerRef,
    isToastActive
  ...
  return import_react5.default.createElement("div", {
    ...
    return import_react5.default.createElement("div", {
      ...
      return import_react5.default.createElement(Toast, {
        ...toastProps,
...
// app/src/utilities/toastify.jsx
...
function ProductCard({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", {
    children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ClientOnly, {
      fallback: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(SimplerStaticVersion, {}, void 0, false, {
        fileName: "app/src/components/ProductCard.jsx",
        lineNumber: 19,
        columnNumber: 29
      }, this),
      children: () => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ComplexComponentNeedingBrowserEnvironment, {}, void 0, false, {
        fileName: "app/src/components/ProductCard.jsx",
        lineNumber: 20,
        columnNumber: 16
      }, this)
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=/build/routes/index-Q3A3XCW2.js.map
