...
var useSyncExternalStore = "useSyncExternalStore" in React4 ? ((module) => module.useSyncExternalStore)(React4) : shim;
var DataStaticRouterContext = /* @__PURE__ */ React4.createContext(null);
if (true) {
...
var Link2 = /* @__PURE__ */ React5.forwardRef(function LinkWithRef(_ref4, ref) {
  let {
    onClick,
    relative,
    reloadDocument,
...
var NavLink = /* @__PURE__ */ React5.forwardRef(function NavLinkWithRef(_ref5, ref) {
  ...
  let nextMatch = React5.useMemo(() => nextLocation ? matchPath({
    path: path.pathname,
    end,
    caseSensitive
...
var Form = /* @__PURE__ */ React5.forwardRef((props, ref) => {
  return /* @__PURE__ */ React5.createElement(FormImpl, _extends2({}, props, {
    ref
  }));
});
if (true) {
 ...
 * @license MIT
 */
//# sourceMappingURL=/build/routes/index-ESAUKXL5.js.map
